...
class incoming extends Component
{
   ...
   public function __construct($incomingDocuments, $users, $classifications, $documentCode, $loggedInUser, $activeUsers, $excludedUsers, $countIncoming, $countOutgoing, $countPending, $totalPages, $page, $perPage, $totalItems)
   {
