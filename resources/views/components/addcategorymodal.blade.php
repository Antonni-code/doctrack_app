       ...
       <div class="w-full flex flex-col bg-white border shadow-sm rounded-xl pointer-events-auto dark:bg-neutral-800 dark:border-neutral-700 dark:shadow-neutral-700/70">
           ...
           <div class="p-4 overflow-y-auto">
                  <form id="classForm" action="#" method="POST">
                     ...
                     <div class="mb-4">
                        <label for="sub-class" class="block text-sm font-medium text-gray-700">Sub-classification</label>
                        <input type="text" id="sub-class" name="sub_class" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm">
                     </div>
