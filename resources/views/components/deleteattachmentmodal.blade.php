<div id="deleteModal" class="fixed inset-0 z-[999] h-screen w-screen flex justify-center items-center bg-black bg-opacity-60 backdrop-blur-sm hidden">
   <div class="relative m-4 p-4 w-2/5 min-w-[40%] max-w-[40%] rounded-lg bg-white shadow-sm">
      ...
      <div class="p-4 md:p-5 text-center">
         ...
         <h3 class="mb-5 text-lg font-normal text-gray-500">
            Are you sure you want to delete <span class="text-red-600 font-semibold" id="attachmentName"></span>?
         </h3>
         <!-- Delete Form -->
