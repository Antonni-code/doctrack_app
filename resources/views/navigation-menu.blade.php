<nav x-data="{ open: false }" class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700 sticky top-0 z-30">
               ...
               <!-- Teams Dropdown -->
                ...
                <div class="ms-3 relative flex items-center justify-between gap-x-8">
                     ...
                     <div>
                        <!-- Notification Bell -->
                        <div class="relative">
                           <button id="notif-button" type="button" class="relative inline-flex items-center hover:bg-gray-100 dark:hover:bg-gray-700 focus:outline-none focus:ring-4 focus:ring-gray-200 rounded-lg p-2.5">
